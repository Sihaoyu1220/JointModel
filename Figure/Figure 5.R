...
# Import the cleaned data and individual parameters
indparest <- read.csv(here::here("Chapter3/Data/Other/indest.csv"), header = TRUE)
data <- read.csv(here::here("Chapter3/Data/Cleaned_data/full2dat_cleaned.csv"), header = TRUE)
...
png(file="Figure/Results/Figure 5_1.png", width=550, height=300)
...
png(file="Figure/Results/Figure 5_2.png", width=550, height=300)
...
png(file="Figure/Results/Figure 5_3.png", width=550, height=300)
...
png(file="Figure/Results/Figure 5_4.png", width=550, height=300)
